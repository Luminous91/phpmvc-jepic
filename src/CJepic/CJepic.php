...
* @package JepicCore
*/
class CJepic implements ISingleton {
   ...
   // time page generation
    ...
    $je = &$this;
    require(JEPIC_SITE_PATH.'/config.php');
    ...
    * @return CJepic The instance of this class.
    */
   public static function Instance() {
      if(self::$instance == null) {
         self::$instance = new CJepic();
      }
 ...
 public function FrontControllerRoute() {
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= JEPIC_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = JEPIC_INSTALL_PATH . '/' . $this->config['theme']['parent'];
      $parentUrl	= $this->request->base_url . $this->config['theme']['parent'];
    }
    
    // Add stylesheet path to the $je->data array
    ...
    $je = &$this;
    // First the default Jepic themes/functions.php
    include(JEPIC_INSTALL_PATH . '/themes/functions.php');
    ...
    // Extract $je->data to own variables and handover to the template file
     extract($this->data);      
  ...
  /**
   * Draw HTML for a menu defined in $je->config['menus'].
   *
